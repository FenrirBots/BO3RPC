...
call %BuildTools64%
call cl.exe /nologo /c /W4 /O2 /MD /D_USRDLL /D_WINDLL /D_NDEBUG /Fo"Bin\Intermediate\\" /I"../Source" /TP "..\Source\Main.cpp" "..\Source\LeoHook\LeoHook.cpp" "..\Source\Discord\Discord.cpp" "..\Source\Loop.cpp" "..\Source\Engine\Cg.cpp" "..\Source\Engine\Com.cpp" "..\Source\Engine\Dvar.cpp" "..\Source\Engine\LobbySession.cpp" "..\Source\Engine\DDL.cpp"
